...
class TicTacToeBoard(tk.Tk):
    ...
    def _create_board_display(self):
        display_frame = tk.Frame(master=self, pady=10)
    ...
    def _update_button(self, row, col):
        button = next(btn for btn, coordinates in self._cells.items() if coordinates == (row, col))
    ...
    def reset_board(self):
        ...
        for button in self._cells.keys():
            button.config(bg="lightblue", text="", fg="black")
